...
import { BriefcaseIcon, ChartBarIcon, CodeBracketIcon, LightBulbIcon } from '@heroicons/react/24/solid';
  ...
  return (
    <section className="relative py-20 bg-gradient-to-b from-white to-green-50 overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
          ...
          {audiences.map((audience, index) => (
            ...
            >
              <div className="p-6 h-full flex flex-col">
                ...
                {/* Konten */}
                <h3 className="text-xl font-bold text-green-900 mb-2">{audience.title}</h3>
                <p className="text-green-700 mb-4 flex-grow">{audience.description}</p>

                {/* Role List */}
                <div className="pt-4 mt-auto border-t border-green-100">
                  <h4 className="text-xs font-semibold text-green-500 uppercase tracking-wider mb-2">Peran Terkait:</h4>
        ...
        >
          <p className="text-green-700 mb-6">Tidak yakin apakah webinar ini cocok untuk Anda?</p>
          <motion.a
            href="#contact"
